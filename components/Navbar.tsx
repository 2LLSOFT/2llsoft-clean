export default function Navbar() {
  return (
    <header className="fixed top-0 z-[100] w-full border-b border-cyan-400/40 bg-black/80 backdrop-blur-2xl">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 text-white md:px-10">
        ...
        <nav className="hidden items-center gap-8 text-sm text-zinc-300 md:flex">
          ...
          <a href="#projects" className="transition hover:text-cyan-300">Portfolio</a>
